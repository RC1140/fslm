...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Setting.SettingKey'
        db.alter_column('spacemanager_setting', 'SettingKey', self.gf('django.db.models.fields.IntegerField')(max_length=1, null=True))


    def backwards(self, orm):
        
        # Changing field 'Setting.SettingKey'
        db.alter_column('spacemanager_setting', 'SettingKey', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))
    ...
    models = {
        ...
        'spacemanager.setting': {
            ...
            'SettingKey': ('django.db.models.fields.IntegerField', [], {'max_length': '1', 'null': 'True'}),
